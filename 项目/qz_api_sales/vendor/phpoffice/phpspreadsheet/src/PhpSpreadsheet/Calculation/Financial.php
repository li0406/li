...
class Financial
{
     ...
     *                            SaleReportInvoiceWithPayment periods are numbered beginning with 1.
     ...
     * @param int $type SaleReportInvoiceWithPayment type: 0 = at the end of each period, 1 = at the beginning of each period
     *
     * @return float|string
     */
