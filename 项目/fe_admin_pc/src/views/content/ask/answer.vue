<template>
  <div class="content-answer">
    <tableSearch title="答案管理">
      <el-form slot="from" ref="ruleForm" :inline="true" :model="fromData">
        <el-form-item label="问题" prop="goodsName">
          <el-input v-model="fromData.goodsName" clearable placeholder="请输入问题" />
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop="goodsNo" label="问题/答案" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.title}}</p>
            <p>{{scope.row.title}}</p>
          </template>
        </el-table-column>
        <el-table-column prop="goodsName" label="回答人" align="center" />
        <el-table-column prop="goodsName" label="回答时间" align="center" />
        <el-table-column prop="goodsSkuName" label="发布来源" align="center" />
        <el-table-column prop="goodsType" label="点赞" align="center" />
        <el-table-column prop="goodsType" label="回复数" align="center" />
