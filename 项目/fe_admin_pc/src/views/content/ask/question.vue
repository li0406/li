  ...
  <div class="content-comment">
    <tableSearch title="问题管理">
      ...
      >
        ...
        <el-table-column prop="goodsNo" label="问题" align="center" />
        <el-table-column prop="goodsName" label="关联商品数" align="center" />
        <el-table-column prop="goodsSkuName" label="发布来源" align="center" />
        <el-table-column prop="goodsType" label="浏览量" align="center" />
        <el-table-column prop="goodsType" label="点赞" align="center" />
        <el-table-column prop="goodsType" label="回复数" align="center" />
        <el-table-column prop="goodsType" label="分类" align="center" />
