<template>
  <div class="system-message-mail">
    <tableSearch title="站内信消息">
      ...
      >
        ...
        <el-table-column prop="orderNo" label="编号" align="center" />
        <el-table-column prop="custName" label="消息标题" align="center" />
        <el-table-column prop="goodsName" label="发布时间" align="center" />
        <el-table-column prop="salePrice" label="发布人员" align="center" />
        <el-table-column prop="saleNum" label="接收对象" align="center" />
