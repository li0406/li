...
return array(
    ...
    'STATIC_VERSION'        => env('STATIC_VERSION', '20200723175905'),
    ...
    'DB_TYPE'               => 'mysql', // 数据库类型
    'DB_HOST'               => env('MYSQL_HOST', ''), // msyql地址,第一个是master,配置替换,不留空格是因为方便替换
    ...
    //注册的域名
    'REGISTER_URL'   => array("https://www.qizuang.com","https://u.qizuang.com","https://oauthtmp.qizuang.com","https://account.qizuang.com"),
    ...
    //定义移美图访问 域名
    'MEITU_DONAMES'  => 'meitu.qizuang.com',
    ...
    //用户中心-账号中心域名
    'QZ_PASSPORT_ACCOUNT_DONAMES'=> 'account.qizuang.com',

    //order.js版本号
    'ORDER_JS_VERSION' => env('STATIC_VERSION', '20200723175905'),
    ...
    'QZ_YUMING_APP_ARR' => [
     ...
     //百度寻客API认证
     'XUNKE_USERNAME' => 'xkqz', //帐号
     'XUNKE_PASSWORD' => '3nRjYNtZ', //密码
    ...
    'SMS_APP_SLOT' => '5ca86ed859e23608b89bc6c7a808354a302521d6',
    //app图片地址前缀
    ...
    //产品线来源信息
    'APP_FROM_PC' => '9f6910a77bc9c8d4cf9db31ed41af490',

    'API_HOST' => 'https://api.qizuang.com',
    //企查查
