...
{
  if (hz6d_fixed_conf[s].img == '') hz6d_fixed_conf[s].img = 'https://tb.53kf.com/style/setting/ver06/img/wk_zixun_cn.gif';
  ...
  href_str = 'https://tb.53kf.com/webCompany.php?arg=' + arg + '&style=' + style + '&keyword=' + escape(hz6d_from_page) + '&kf=' + kflist;
