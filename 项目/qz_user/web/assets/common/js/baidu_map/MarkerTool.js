...
(function() {    
    ...
    (function() {
        ...
        */
        ...
        baidu.on    = BMapLib.EventWrapper.addListener;
        baidu.un    = BMapLib.EventWrapper.removeListener;
        baidu.ondom = BMapLib.EventWrapper.addDomListener;
    })();
    ...
    MarkerTool.prototype.close = function(){
        ...
        // 删除绑定的事件
        for (var i = 0, l = this.evtListeners.length; i < l; i ++){
            baidu.un(this.evtListeners[i]);
        }
    ...
    MarkerTool.prototype._bind = function(){
        ...
        me.evtListeners.push(baidu.ondom(document, "keydown", distKeyDown));
        ...
        me.evtListeners.push(baidu.on(me._map, "mousemove", me._mouseMoveHandler));
        ...
        me.evtListeners.push(baidu.on(me._map, "click", me._clickHandler));
    };
    
    MarkerTool.CUR_IMG = "https://api.map.baidu.com/library/MarkerTool/1.2/src/images/transparent.cur"; //鼠标透明样式，发布时候修改为绝对路径
    MarkerTool.ICON_IMG = "https://api.map.baidu.com/library/MarkerTool/1.2/src/images/us_mk_icon.png"; //图标样式，发布时候修改为绝对路径
