...
(function() {
    ...
    DistanceTool.prototype._addSecPoint = function(pt){
        var ico = 
            this._opts.secIcon ? 
                this._opts.secIcon :
                new BMap.Icon("https://api.map.baidu.com/images/mapctrls.png", new BMap.Size(11, 11), {imageOffset: new BMap.Size(-26, -313)});
    ...
    DistanceTool.prototype._processLastOp = function() {
        ...
        var bico = 
            this._opts.closeIcon ? 
                this._opts.closeIcon :
                new BMap.Icon("https://api.map.baidu.com/images/mapctrls.gif", new BMap.Size(12, 12), {imageOffset: new BMap.Size(0, -14)});
    ...
    var OperationMask = {
         ...
         * @type {String}
         */
        _html : "<div style='background:transparent url(//api.map.baidu.com/images/blank.gif);position:absolute;left:0;top:0;width:100%;height:100%;z-index:1000' unselectable='on'></div>",
