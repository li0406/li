...
Page({
    ...
    onLoad: function (options) {
        ...
        swan.setPageInfo({
            title: '户型设计_装修招标_免费装修设计与报价-齐装网',
            keywords: '装修设计,户型设计,室内装修设计,装修报价,装修报价单',
            description: '齐装网是国内领先的专业的家装、公装项目招标平台,业主可以在齐装网免费发布装修招标,提供装修招标、免费装修设计与报价,免费为业主提供4份室内装修设计方案与报价,并免费获得多套装修设计与报价方案,让您装修省钱省力更省心！'
        })
    },
    /**
     * 生命周期函数--监听页面初次渲染完成
