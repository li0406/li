...
Page({
    ...
    formSubmit: function (e) {
        ...
        console.log(that.data.src,'11111111');
        if (that.data.src) {
            swan.request({
    ...
    onLoad: function (options) {
        ...
        swan.setPageInfo({
            title: '户型设计 - 快速免费获取装修设计方案 - 齐装网',
            keywords: '装修设计,户型设计,室内装修设计,装修设计方案',
            description: '齐装网免费装修设计与报价,免费为业主提供4份室内装修设计方案与报价,并免费获得多套装修设计与报价方案,让您装修省钱省力更省心！'
        })
    },
    /**
     * 生命周期函数--监听页面初次渲染完成
