...
let levelOneNav = [{ id: 0, text: "客厅风水", cate: "ktfs", fs: 115 }, { id: 1, text: "卧室风水", cate: "wsfs", fs: 116 }, { id: 2, text: "厨房风水", cate: "cffs", fs: 117 }, { id: 3, text: "卫生间风水", cate: "wsjfs", fs: 118 }, { id: 4, text: "办公室风水", cate: "bgsfs", fs: 119 }, { id: 5, text: "财运风水", cate: "cyfs", fs: 120 }, { id: 6, text: "其他风水", cate: "qtfs", fs: 140 }];
...
Page({
  ...
  setTab: function (e, options) {
    let id = e ? e.currentTarget.dataset.id : options.id,
      ...
      fs = e ? e.currentTarget.dataset.fs : options.fs;
