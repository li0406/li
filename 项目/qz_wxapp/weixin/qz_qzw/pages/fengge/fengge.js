...
let levelOneNav = [{ id: 0, text: "地中海风格", cate: "dzh", style: 122 }, { id: 1, text: "田园风格", cate: "ty", style: 123 }, { id: 2, text: "欧式风格", cate: "os", style: 124 }, { id: 3, text: "现代简约", cate: "xdjy", style: 125 }, { id: 4, text: "中式风格", cate: "zhsh", style: 126 }, { id: 5, text: "东南亚风格", cate: "dnyfg", style: 127 }, { id: 6, text: "美式风格", cate: "ms", style: 128 }, { id: 7, text: "混搭风格", cate: "hd", style: 129 }, { id: 8, text: "日韩风格", cate: "rh", style: 130 }];
...
Page({
  ...
  setTab: function (e, options) {
    let id = e ? e.currentTarget.dataset.id : options.id,
      ...
      style = e ? e.currentTarget.dataset.style : options.style;
