...
Page({
            ...
            wx.request({
                ...
                method: "POST",
                  success: function (res) {
                    ...
                    app.globalData.fadanNum = parseInt(app.globalData.fadanNum)+1;
    ...
    Mianji: function (e) {
        ...
        // var reg3 = new RegExp("^[1-9][0-9]{0,3}$");
        // if (!reg3.test(parseInt(e.detail.value))) {
        //     alertViewWithCancel("提示", "请输入大于1小于10000的数字", function () { });
        // }
    },
