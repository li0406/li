...
App({
    onLaunch: function (options) {
        ...
        if (options.scene == 1020 || options.scene == 1035 || options.scene == 1036 || options.scene == 1037 || options.scene == 1038 || options.scene == 1043){
          ...
          wx.request({
            url: apiUrl + 'AppletManage/getSmallProgramInfo?appid=' + options.referrerInfo.appId,
            header: {
            ...
            success: function (res) {
              if (res.status==1){
                _this.globalData.sourceMark =res.data.src;
              }else{
                _this.globalData.sourceMark = 'xcx-zrll-zxzs';
              }
            }
          })
        }else{
          this.globalData.sourceMark = 'xcx-zrll-zxzs';
        }
    },
