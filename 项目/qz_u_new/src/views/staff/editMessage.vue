<template>
<div class="editMessage-contains" v-loading="loading">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="姓名：" prop="nick_name">
            <el-col class="form-item">
                <el-input v-model="ruleForm.nick_name" oninput="value=value.replace(/[^\a-zA-Z\u4E00-\u9FA5]/g,'')" maxlength="8" placeholder="请输入姓名"></el-input>
            </el-col>
        </el-form-item>
        <el-form-item label="职位：" prop="position">
            <el-col class="form-item">
                <el-select v-model="ruleForm.position" placeholder="请选择" v-if="ruleForm.position==1">
                    <el-option v-show="item.value==1" v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
                <el-select v-model="ruleForm.position" placeholder="请选择" v-else>
                    <el-option v-show="item.value!=1" v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
                </el-select>
            </el-col>
        </el-form-item>
        ...
        <el-form-item label="擅长风格：" prop="checkedFg" v-if="isMore" key="checkedFg">
            <el-checkbox :indeterminate="isIndeterminateFg" v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
        ...
        <el-form-item label="擅长领域：" prop="checkedLy" v-if="isMore" key="checkedLy">
            <el-checkbox :indeterminate="isIndeterminateLy" v-model="checkAllLy" @change="handleCheckAllChangeLy">全选</el-checkbox>
            <div style="margin: 15px 0;"></div>
        ...
        <el-form-item label="荣誉奖励：">
            <el-col :span="6">
                <el-input type="textarea" :rows="5" maxlength="600" placeholder="请输入内容" v-model="ruleForm.honor"></el-input>
                <span class="item-words">{{oddC}}/600</span>
            </el-col>
        </el-form-item>
        <el-form-item label="代表作品：" v-if="isMore">
            <el-col :span="6">
                <el-input type="textarea" :rows="5" maxlength="600" placeholder="请输入内容" v-model="ruleForm.works"></el-input>
                <span class="item-words">{{oddD}}/600</span>
            </el-col>
        </el-form-item>
        <el-form-item label="设计理念：" v-if="isMore">
            <el-col :span="6">
                <el-input type="textarea" :rows="5" maxlength="600" placeholder="请输入内容" v-model="ruleForm.concept"></el-input>
                <span class="item-words">{{oddE}}/600</span>
            </el-col>
        </el-form-item>
        <el-form-item label="个人简介：">
            <el-col :span="6">
                <el-input type="textarea" :rows="5" maxlength="600" placeholder="请输入内容" v-model="ruleForm.profile"></el-input>
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                checkedFg: [{
                    required: true,
                    validator: validateFg,
                    trigger: 'change'
                }],
                checkedLy: [{
                    required: true,
                    validator: validateLy,
                    trigger: 'change'
                }],
            },
            account: '',
