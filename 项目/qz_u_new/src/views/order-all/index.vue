                        ...
                        <div v-if="show" class="message">
                            ...
                            <qz-search-item for="is_read" label="订单类型:" style="margin: 16px 16px 0 0;">
                                <el-select v-model="searchValue.type_fw" placeholder="订单类型">
                                    <el-option key="0" label="全部" value></el-option>
                                    <el-option key="1" label="有效单" :value="1"></el-option>
                                    <el-option key="2" label="赠送单" :value="2"></el-option>
                                    <el-option key="3" label="补轮单" :value="3"></el-option>
                                </el-select>
                            </qz-search-item>
...
export default {
    ...
    methods: {
        ...
        async getTableData() {
            ...
            const res1 = await ApiOrder.list();
            if (res1.data.error_code === 4000100) {
                ...
                const res2 = await ApiOrder.list({
                    ...this.search,
