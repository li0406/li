...
export default {
  ...
  created() {
    console.log(this.$route.query.orderid,'lllllllll')
  },
  methods: {
    toogleDes(index,id) {
    ...
    subFn() {
      ...
      premark(obj).then((res) => {
        ...
        if(res.data.error_code ===0){
          location.href = '/qzw/room-free-hour?orderid=' + this.$route.query.orderid
        }
      })
      this.$bridge.callNative('Native_bory_point', ' zhuangqi_list_lf_bc-nextbut', function (res) {
      })
    }
  }
