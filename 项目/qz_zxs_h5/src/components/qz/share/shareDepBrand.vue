  ...
  <section class="bg">
    ...
    <div class="share-brand">
        <div class="top-banner">
           <img src="../../../assets/img/qz/share/xinlai.png" class="top-banner-bg"/>
        </div>
        <div class="main">
            <ul class="list">
                <li v-for="(val,index) in list" :key="index">
                    ...
                    <div class="info">
                        ...
                        <p><span>案例：{{val.case_count}}</span>&nbsp;|&nbsp;<span>设计师：{{val.designer_count}}</span></p>
                    </div>
                    <div class="right">
...
import { shareDepBrand } from '@/api/api'
export default {
  name: 'shareDepBrand',
  components: {
    openApp,
