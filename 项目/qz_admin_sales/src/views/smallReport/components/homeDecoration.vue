            ...
            <el-row class="mb-20">
                ...
                <el-col :span="18">
                    <el-form-item prop="paymentMoney">
                        <el-input v-if="unCheckEditTag" v-model="ruleForm.paymentMoney" placeholder="请输入" :disabled="true"></el-input>
                        <el-input v-else v-model="ruleForm.paymentMoney" type="text" placeholder="请输入"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row class="mb-20">
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    paymentAccountType: [
                        { required: true, message: '请输入收款账户及方式', trigger: 'change' }
                    ]
                },
                backRatioOptions: [{
                    value: '',
