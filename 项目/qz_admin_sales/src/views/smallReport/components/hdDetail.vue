<template>
    <div class="home-decoration-detail">
        <div class="main">
            ...
            <el-row class="mb-20 lh-40">
                <el-col :span="3"><div>会员倍数：</div></el-col>
                <el-col :span="18">{{ ratio }}</el-col>
            </el-row>
            <el-row class="mb-20 lh-40">
...
<script>
    ...
    export default {
        ...
        created() {
          ...
          console.log(this.person_list.length)
        },
        methods: {
            prev() {
            ...
            setData(data) {
                ...
                for(var i = 0;i < ret.auth_imgs.length;i++){
                    this.img_list[i] =  ret.auth_imgs[i].img_full
                }
                ...
                this.payment_account_type_name = ret.payment_account_type_name
